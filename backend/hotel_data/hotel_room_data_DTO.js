...
class TaxDetails{
    constructor(builder){
        ...
        this.includedTaxesFeesTotalInCurrency = builder.includedTaxesFeesTotalInCurrency;
        this.excludedTaxesFeesTotal = builder.excludedTaxesFeesTotal;
        this.excludedTaxesFeesTotalInCurrency = builder.excludedTaxesFeesTotalInCurrency;
        this.includedTaxesFeesDetails = builder.includedTaxesFeesDetails;
        this.includedTaxesFeesInCurrencyDetails = builder.includedTaxesFeesInCurrencyDetails;
        this.excludedTaxesFeesInCurrencyDetails = builder.excludedTaxesFeesInCurrencyDetails;
    ...
    static get Builder(){
        return class{
            ...
            setIncludedTaxesFeesTotalInCurrency(includedTaxesFeesTotalInCurrency){
                this.includedTaxesFeesTotalInCurrency = includedTaxesFeesTotalInCurrency;
                return this;
            }
            ...
            setExcludedTaxesFeesTotalInCurrency(excludedTaxesFeesTotalInCurrency){
                this.excludedTaxesFeesTotalInCurrency = excludedTaxesFeesTotalInCurrency;
                return this;
            }
            ...
            setIncludedTaxesFeesInCurrencyDetails(includedTaxesFeesInCurrencyDetails){
                this.includedTaxesFeesInCurrencyDetails = includedTaxesFeesInCurrencyDetails;
                return this;
            }
            setExcludedTaxesFeesInCurrencyDetails(excludedTaxesFeesInCurrencyDetails){
                this.excludedTaxesFeesInCurrencyDetails = excludedTaxesFeesInCurrencyDetails;
                return this;
            }
