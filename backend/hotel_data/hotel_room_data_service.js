...
class HotelRoomDataTransferService{
    ...
    transferKeyRoomDetails(){
        ...
        .setRoomNormalisedDescription(this.jsonData.roomNormalisedDescription)
    ...
    transferPriceDetails(){
        ...
        .setConvertedMaxCashPayment(this.jsonData.converted_max_cash_payment)
    ...
    transferRoomAdditionalInfo(){
        ...
        .setSpecialCheckInInstructions(this.jsonData.roomAdditionalInfo.displayFields.special_check_in_instructions)
        .setKnowBeforeYouGo(this.jsonData.roomAdditionalInfo.displayFields.know_before_you_go)
        .setOptionalFees(this.jsonData.roomAdditionalInfo.displayFields.fees_optional)
        .setMandatoryFees(this.jsonData.roomAdditionalInfo.displayFields.fees_mandatory)
        .setKaligoServiceFee(this.jsonData.roomAdditionalInfo.displayFields.kaligo_service_fee)
    ...
    transferTaxDetails(){
        ...
        .setIncludedTaxesFeesTotalInCurrency(this.jsonData.included_taxes_and_fees_total_in_currency)
        .setExcludedTaxesFeesTotal(this.jsonData.excluded_taxes_and_fees_total)
        .setExcludedTaxesFeesTotalInCurrency(this.jsonData.excluded_taxes_and_fees_total_in_currency)
        .setIncludedTaxesFeesDetails(this.jsonData.included_taxes_and_fees)
        .setIncludedTaxesFeesInCurrencyDetails(this.jsonData.included_taxes_and_fees_in_currency)
...
module.exports = {hotelRoomDataDTOClassList, getSingleHotelPriceDetails, getSingleHotelDetailsWithoutPrice}