...
const bookingSchema = Joi.object({
  ...
  hotel_id: Joi.string().alphanum().min(1).max(255).required(),
  destination_id: Joi.string().alphanum().min(1).max(255).required(),
